...
(function() {
  var $, Assoc, CartSelectView, Color, ColorSelectView, DataLoader, ELSE, FormView, IF, Model, PartImageView, Retention, SelectModel, SelectView, StoreDataLoader, SuperArray, View, escapeHTML, uuid, xhrget,
  ...
  (function() {
    var addItem, calculate, cart, cartSelect, categorySelect, colorSelect, editItem, partSelect, removeItem;
