...
(function() {
  var $, Assoc, CartSelectView, Color, ColorSelectView, DataLoader, DataProcessor, ELSE, FormView, IF, Model, PartImageView, Retention, SelectModel, SelectView, StoreDataLoader, SuperArray, View, escapeHTML, uuid, xhrget,
  ...
  StoreDataLoader = (function() {
    ...
    StoreDataLoader.prototype.load = function(callback, items) {
      var data, item;
      data = (function() {
        ...
        for (_i = 0, _len = items.length; _i < _len; _i++) {
          item = items[_i];
          _results.push(xhrget(baseurl, item));
        }
        return _results;
      })();
  ...
  DataProcessor = (function(_super) {
    ...
    DataProcessor.prototype.process = function(items) {
      var _this = this;
      this.items = items;
      return this._loader.load(function(data) {
    ...
    DataProcessor.prototype.makeMatrix = function(storeData) {
      ...
      return this.stores = (function() {
        var _results;
        _results = [];
        for (key in Object.key(storeMap)) {
  ...
  (function() {
    var addItem, calculate, cart, cartSelect, categorySelect, colorSelect, editItem, partSelect, processor, removeItem;
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      return $('calculateButton').addEventListener('click', calculate, false);
    }, false);
