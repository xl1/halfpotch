...
(function() {
  var $, Assoc, CartSelectView, Color, ColorSelectView, DataLoader, DataProcessor, ELSE, FormView, IF, ItemStoreMatrix, Model, PartImageView, ProgressButton, ResultView, Retention, Searcher, SelectModel, SelectView, Solver, StoreDataLoader, SuperArray, View, escapeHTML, uuid, xhrget,
  ...
  DataLoader = (function() {
    ...
    DataLoader.prototype.baseurl = '/script/getpartsdata';
    ...
    DataLoader.prototype.load = function(callback, errorCallback) {
      ...
      parts = {};
      categories = {};
      colorsData = this.get(this.baseurl + '?num=3');
      codesData = this.get(this.baseurl + '?num=5');
      partsData = this.get(this.baseurl + '?num=0');
