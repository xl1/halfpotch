constants =
  mosaic:
    ...
    colors: do ->
      cls = [
        [ 11, 'Black',              33,  33,  33, true]
        [ 10, 'Dark Gray',         107,  90,  90, true]
        [  9, 'Light Gray',        156, 156, 156, true]
        [ 49, 'Very Light Gray',   232, 232, 232, true, true]
        [  1, 'White',             255, 255, 255, true]
        [ 85, 'Dark Bluish Gray',   89,  93,  96]
        [ 86, 'Light Bluish Gray', 175, 181, 199]
        [  7, 'Blue',                0,  87, 166]
        [  5, 'Red',               179,   0,   6]
        [  3, 'Yellow',            247, 209,  23]
        [  6, 'Green',               0, 100,  46]
        [  2, 'Tan',               222, 198, 156]
        [ 88, 'Reddish Brown',     137,  53,  29]
        [ 63, 'Dark Blue',          20,  48,  68]
        [104, 'Bright Pink',       243, 154, 194]
        [  8, 'Brown',              83,  33,  21]
        [ 89, 'Dark Purple',        95,  38, 131]
        [ 59, 'Dark Red',          106,  14,  21]
        [ 69, 'Dark Tan',          144, 116,  80]
        [ 39, 'Dark Turquoise',      0, 138, 128]
        [ 34, 'Lime',              166, 202,  85]
        [ 72, 'Maersk Blue',       107, 173, 214]
        [ 42, 'Medium Blue',        97, 175, 255]
        [157, 'Medium Lavender',   181, 165, 213]
        [ 31, 'Medium Orange',     255, 165,  49]
        [  4, 'Orange',            255, 126,  20]
        [ 23, 'Pink',              255, 199, 225]
        [ 24, 'Purple',            165,  73, 156]
        [ 55, 'Sand Blue',          90, 113, 132]
        [ 48, 'Sand Green',        118, 162, 144]
      ]
      for [id, name, r, g, b, use, checked] in cls
        { id, name, color: new Color(r, g, b), use, checked }
