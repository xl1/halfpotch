...
(function() {
  var $, Assoc, CartSelectView, Color, ColorSelectView, DataLoader, DataProcessor, ELSE, FormView, IF, ItemStoreMatrix, Model, PartImageView, ProgressButton, ResultView, Retention, Router, Searcher, SelectModel, SelectView, Solver, StoreDataLoader, SuperArray, View, constants, escapeHTML, unescapeHTML, uuid, xhrget, _ref, _ref1,
  ...
  ColorSelectView = (function(_super) {
    ...
    function ColorSelectView() {
      _ref = ColorSelectView.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  CartSelectView = (function(_super) {
    ...
    function CartSelectView() {
      _ref1 = CartSelectView.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  ResultView = (function(_super) {
    ...
    ResultView.prototype._createRow = function(item, store) {
      var price, text, tr, url, _ref2;
      _ref2 = this.model.matrix.get(item, store), price = _ref2.price, url = _ref2.url;
    ...
    ResultView.prototype.render = function() {
      var solution, table, tbody, _i, _len, _ref2;
      ...
      _ref2 = this.model.result.slice(0, 20);
