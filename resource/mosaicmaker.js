...
(function() {
  ...
  ImageProcessor = (function() {
    ...
    ImageProcessor.prototype._reduceColor = function() {
      var canv, color, colorData, height, i, name, width, _i, _len, _ref;
      colorData = this._colorCtx.createImageData(32, 1);
      _ref = Object.keys(this.colors);
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        name = _ref[i];
        color = this.colors[name];
        if (color.use) {
          colorData.data.set([color.color.r, color.color.g, color.color.b, 255], i << 2);
        }
      }
      ...
      return this._renderGL(this.width, this._canvasHeight, this.shader.reduceColor, canv, this.colorReduced, {
        u_colors: this._colorCtx.canvas,
        u_vivid: this.vivid,
